  ...
  return (
    <>
      ...
      <Helmet>
        ...
        <meta name="description" content="Register for a free account on our E-Commerce website" />
        <meta name="keywords" content="E-Commerce, Shopping, Register" />
      </Helmet>
      <div className="min-h-screen bg-gray-100 text-gray-900 flex justify-center">
        <div className="max-w-screen-xl m-0 sm:m-10 bg-white shadow sm:rounded-lg flex justify-center flex-1">
          <div className="lg:w-1/2 xl:w-5/12 p-6 sm:p-12">
            <div>
              <h1 className="text-2xl xl:text-3xl font-bold text-center text-gray-500">Register to Continue</h1>
            </div>
              ...
              <div className="w-full flex-1">
                ...
                <form onSubmit={handleSubmit} className="mx-auto max-w-xs">
                  ...
                  <input 
                    ...
                    placeholder="In which City You Born" 
                    required
                  />
                ...
                <div className="mt-6 text-center">
                  ...
                  <Link to="/login" className="mt-2 tracking-wide font-semibold bg-white text-green-500 w-full py-4 rounded-lg hover:bg-green-50 transition-all duration-300 ease-in-out flex items-center justify-center focus:shadow-outline focus:outline-none border border-green-500">
                    <svg className="w-6 h-6 -ml-2" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
