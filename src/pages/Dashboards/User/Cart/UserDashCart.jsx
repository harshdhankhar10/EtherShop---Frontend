              ...
              >
                <div className="bg-white rounded-2xl shadow-lg p-6">
                  ...
                  <div className="mt-8">
                    ...
                    <button className="w-full bg-green-500 text-white px-6 py-3 rounded-full hover:bg-green-600 transition-colors duration-300 font-semibold text-lg shadow-md hover:shadow-lg transform hover:-translate-y-1">
                      Proceed to Checkout
                    </button>
